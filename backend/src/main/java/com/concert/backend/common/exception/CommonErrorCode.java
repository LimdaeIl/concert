...
public enum CommonErrorCode implements ErrorCode {
    ...
    DATA_STORE_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "데이터 저장소에 일시적으로 접근할 수 없습니다."),
    REDIS_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "임시 데이터 저장소에 일시적으로 접근할 수 없습니다.");
